      ...
      .map((session, index) => {
        ...
        <div class="session-row-outer">
            ...
            <div class="${CSS_CLASSES.SESSION_ITEM} ${isActive ? CSS_CLASSES.ACTIVE : ""}"
              ...
              <div class="session-info">
                <div class="session-name limit-name">
                  ...
                  <span class="session-name-text">${session.name || UI_TEXT.UNNAMED_SESSION}</span>
                </div>
          ...
          <div class="session-actions-inline">
            <button class="session-btn rename-btn" data-action="rename" data-session-id="${session.id}">Edit</button>
            <button class="session-btn delete-btn" data-action="delete" data-session-id="${session.id}">Delete</button>
          </div>
        </div>
      `;
      })
      ...
      .map((session, index) => {
        ...
        <div class="session-row-outer">
          <div class="${CSS_CLASSES.SESSION_ITEM} ${isActive ? CSS_CLASSES.ACTIVE : ""}"
            ...
            <div class="session-actions-inline">
              <button class="session-btn rename-btn" title="Edit" data-action="rename" data-session-id="${session.id}">
              ...
              <button class="session-btn delete-btn" title="Delete" data-action="delete" data-session-id="${session.id}">
                <svg class="icon" viewBox="0 0 24 24" aria-hidden="true">
